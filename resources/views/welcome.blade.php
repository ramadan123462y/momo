    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h3 class="mb-3 tx-20 text-white"> ايرادات اليوم</h3>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-20 text-white op-7">
                                    {{ $orders_count_day }}
                                </p>
                            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h3 class="mb-3 tx-20 text-white"> ايرادات السنويه</h3>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h3 class="mb-3 tx-20 text-white"> اصناف انتهت</h3>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p style="color:black" class="mb-0 tx-20 text-white op-7">
                                    {{ $end_prodcuts }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-secondary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h3 class="mb-3 tx-20 text-white"> شارفت علي الانتهاء</h3>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class=" ">
