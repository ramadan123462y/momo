...
<div class="row">
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <a href="{{ url('delete_all') }}" class="btn btn-outline-success">
                <span class="text-balck">{{ 'نقل  الكل الي الارشيف' }}</span></a>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('order/delete', $order->id) }}" class="btn btn-outline-danger">
                                            <span class="text-warning">{{ 'نقل الي الارشيف' }}</span></a>
