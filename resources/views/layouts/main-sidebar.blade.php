...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">الارشيف</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">الارشيف</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    <li><a class="slide-item" href="{{ url('arshefed') }}"> ارشيف المبيعات</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">عمل تقرير</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    <li><a class="slide-item" href="{{ url('make_report') }}"> عمل تقرير للادويه</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('cashier') }}">   عمل طلب بيع </a></li>
                    <li><a class="slide-item" href="{{ url('order') }}">   المبيعات</a></li>
            ...
            {{-- <li class="side-item side-item-category"><a href="{{ url('cashier') }}"><i
                        class="fa-solid fa-cart-plus fa-xl"></i>بيع دواء</a></li>

            </li>

            <li class="side-item side-item-category"><a href="{{ url('order') }}"> <i
                        class="fa-regular fa-clipboard fa-2xl"></i>المبيعات</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('section') }}">الصنف</a></li>


                    <li><a class="slide-item" href="{{ url('product') }}">الادويه</a></li>
                    <li><a class="slide-item" href="{{ route('unite.index') }}">الوحدات</a></li>
